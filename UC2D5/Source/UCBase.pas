...
begin
  ...
  begin
    ...
    UserPermis.UCXPStyle.XPSettings := Self.Settings.XpStyleSet;
...
begin
 ...
 with Settings.ChangePassword do begin
   ...
   TTrocaSenha(FormTrocarSenha).UCXPStyle.XPSettings := Self.Settings.XpStyleSet;
...
begin
  ...
  MsgsForm.UCXPStyle.XPSettings := Self.FUserControl.Settings.XpStyleSet;
...
begin
  ...
  begin
    ...
    Self.AppMessages := TUserSettings(Source).AppMessages;
    Self.XPStyleSet := TUserSettings(Source).XPStyleSet;
  end else inherited;
end;
