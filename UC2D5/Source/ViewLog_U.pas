...
begin
  ...
  TUserControl(Owner).Log(Format('Efetuada exclusão de log do sistema : Usuário = "%s" | Data = %s a %s | Nível <= %s',[comboUsuario.text, DateTimeToStr(Data1.datetime), DateTimeToStr(Data2.datetime), ComboNivel.text ]),2);
